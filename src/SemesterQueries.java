...
public class SemesterQueries {
    ...
    public static void addSemester(String name)
    {
        ...
        try
        {
            addSemester = connection.prepareStatement("insert into app.semesters (name) values (?)");
    ...
    public static ArrayList<String> getSemesterList()
    {
        ...
        try 
        {
            getSemesterList = connection.prepareStatement("select name from app.semesters order by name");
